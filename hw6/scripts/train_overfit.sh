...
# runs your code
srun python classification_plot_overfit.py  --experiment "full" --device cuda --model "distilbert-base-uncased" --batch_size "64" --lr 1e-4 --num_epochs 30
