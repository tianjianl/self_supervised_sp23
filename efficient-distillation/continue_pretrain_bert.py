...
def main(args):
    ...
    wandb.init(project=f"bert-continue-pretrain", entity="bismarckbamfo91", name=wandb_name, settings=wandb.Settings(start_method="fork"))
    ...
    for epoch in range(args.epoch):
        ...
        torch.save(model.state_dict(), f"/scratch4/cs601/bodoom1/bert-checkpoints/bert-large-bookcorpus-{epoch}.pt")
